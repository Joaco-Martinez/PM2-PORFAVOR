    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900 lg:px-6 lg:py-4">
      <div className="container mx-auto max-w-screen-xl flex justify-between items-center">
        ...
        <div className="flex items-center space-x-3 lg:order-2">
          ...
          <div className={`lg:flex ${isOpen ? 'flex' : 'hidden'} items-center justify-around w-full lg:min-w-[400px]`} id="navbar-cta">
            <ul className="flex flex-col lg:flex-row items-center font-medium justify-between w-full p-4 lg:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 lg:mt-0 lg:border-0 lg:bg-white dark:bg-gray-800 lg:dark:bg-gray-900 dark:border-gray-700">
              <li>
